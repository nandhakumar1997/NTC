 ...
 * An open source plugin created to reduce the work in converting time stamps.
 *
 * ## NOTE ##
 * Time stamp must be generated only as date("d-m-Y-h-i-s-a"); for NTC to work
 * properly.
 *
 * ## MODULES ##
 * 1. NTC_ZOMBIE: The default module I use in my projects.
 * 2. NTC_FB: It converts time stamps in the same way that FB does.
 *
 * ## HOW TO USE ##
...
class ntc {
    ...
    public function get_months($ip) {
        switch ($ip) {
            case '01': return $this->month_word = 'January';
            case '02': return $this->month_word = 'February';
            case '03': return $this->month_word = 'March';
            case '04': return $this->month_word = 'April';
            case '05': return $this->month_word = 'May';
            case '06': return $this->month_word = 'June';
            case '07': return $this->month_word = 'July';
            case '08': return $this->month_word = 'August';
            case '09': return $this->month_word = 'September';
            case '10': return $this->month_word = 'October';
            case '11': return $this->month_word = 'November';
            case '12': return $this->month_word = 'December';
        }
    }
